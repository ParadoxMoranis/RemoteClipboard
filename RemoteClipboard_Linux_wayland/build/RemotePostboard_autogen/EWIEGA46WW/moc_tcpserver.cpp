...
void TcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (TcpServer::*)(const QString & )>(_a, &TcpServer::clientDisconnected, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (TcpServer::*)(const QString & , const QString & )>(_a, &TcpServer::dataReceived, 2))
            return;
...
// SIGNAL 2
void TcpServer::dataReceived(const QString & _t1, const QString & _t2)
{
